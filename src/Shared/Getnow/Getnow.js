					...
					<div className='hero-content text-center text-neutral-content'>
						<div className='max-w-xl mt-[20rem]'>
							...
							<p className='mb-5 font-paragraph'>
								...
								Defense Projects, military mission control technology, and
								several projects in the military grade. The{' '}
								<span className='font-bankgothic'>“TARS UNIVERSE”</span>
								project is also a popular{' '}
								<span className='font-couriernew '>TARS BINARY</span> project.
							</p>
							<div className='flex items-center justify-center'>
								<label
