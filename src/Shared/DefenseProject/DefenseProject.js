				...
				<div className='modal pt-16'>
					<div className='modal-box w-full md:w-8/12 max-w-5xl bg-black text-white'>
						...
						<p className='p-6  font-paragraph text-center text-sm'>
							...
							manufactures highly complex Software Defined Radio (SDR) systems
							for gathering, analyzing, and sharing signals intelligence and
							other complex needs of the Intelligence, Defense, and Security
