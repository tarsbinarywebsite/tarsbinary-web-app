...
const Footer = () => {
	...
	return (
		<>
			...
			<div className='footer-container text-base-content mt-10 mx-auto w-full sm:max-w-xl md:max-w-full lg:max-w-screen-xl'>
				...
				<footer className='footer px-5 lg:px-10 py-2 mx-auto max-w-full lg:max-w-screen-xl text-base-content border-base-300 border-t flex flex-col lg:flex-row items-start lg:items-center  justify-between'>
					<div className=' order-2 lg:order-1 text-xs'>
						<p>
							Copyright © 2023{' '}
							<span>
								<img
					...
					<div className='order-3 lg:order-2 -mt-8 lg:-mt-0 '>
					...
					<div className='justify-start lg:justify-end grid-flow-col order-1 lg:order-3 -mb-4 lg:-mb-0 text-xs'>
						<p>Bangladesh</p>
					</div>
				</footer>
			</div>
